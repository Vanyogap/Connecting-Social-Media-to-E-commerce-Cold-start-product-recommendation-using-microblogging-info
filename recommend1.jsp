        ...
        <div id="content">
           ...
           <!---@1 part Start--->
            <center><div class="col_w300">
                     <!---@1 part Start--->
                     <h3 class="service2" style="color: orange">Add new product </h3>
                     <form action="Recommends1" enctype="multipart/form-data" method="post"> 
<!--                         <input type="text" placeholder="Gender" class="inputs" name="gen" /><br>
                         ...
                         <input type="text" placeholder="Interests" class="inputs" name="interest"/><br>-->
                          <input type="text" placeholder="Category" class="inputs" name="cat"/><br>
