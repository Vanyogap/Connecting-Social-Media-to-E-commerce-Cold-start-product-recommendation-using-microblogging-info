...
<body class="padTop53 " >
    <div id="wrap" >
        ...
        String sql="select * from request where name='"+uname+"' and status='"+status+"'";
        ResultSet rs=stes.executeQuery(sql);
        while(rs.next())
        {
            fname=rs.getString("fname");
            Statement st=con.createStatement();
            String sql1="select * from review_ where pcat='"+cat+"' and uname='"+fname+"'";
