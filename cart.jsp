        ...
        <div id="content">
           ...
           <!---@1 part Start--->
            <center><div class="col_w300">
                     <!---@1 part Start--->
                     <h3 class="service2" style="color: orange">Add To Cart</h3>
                     <form action="e_commerce.jsp"  method="post"> 
<!--                         <input type="text" placeholder="Gender" class="inputs" name="gen" /><br>
                         ...
                         <input type="text" placeholder="Interests" class="inputs" name="interest"/><br>-->
                          <input type="text" value="<%=cat%>" class="inputs" name="pcat"/><br>
                          <input type="hidden" value="<%=pid%>" class="inputs" name="pid"/><br>
                          <input type="text" value="<%=pname%>" class="inputs" name="pname"/><br>
                           <input type="text" value="<%=uname%>" class="inputs" name="uname"/><br>
                           <input type="text" value="<%=email%>" class="inputs" name="email"/><br>
                           <input type="text" value="<%=rate%>" class="inputs" name="prate"/><br>
                           <input type="hidden" value="sucess" name="msg">
