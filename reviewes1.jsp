...
<!--                         <input type="text" placeholder="Gender" class="inputs" name="gen" /><br>
                         ...
                         <input type="text" placeholder="Interests" class="inputs" name="interest"/><br>-->
                          <input type="text" value="<%=cat%>" class="inputs" name="cat"/><br>
                          <input type="text" value="<%=pname%>" class="inputs" name="pname"/><br>
                           <input type="text" value="<%=uname%>" class="inputs" name="pname"/><br>
                           <input type="text" value="<%=email%>" class="inputs" name="pname"/><br>
                           <input type="text" value="<%=rate%>" class="inputs" name="pname"/><br>
