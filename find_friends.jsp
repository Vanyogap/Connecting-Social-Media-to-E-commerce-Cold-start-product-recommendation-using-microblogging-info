<%-- 
    ...
    Created on : Dec 13, 2016, 12:37:08 PM
    Author     : java4
--%>
        ...
        <div id="content">
           ...
           <center>
               <div class="col_w300 last_col">
                                                     ...
                                                     <font color="#FF8000" size="5"><strong><br>Friends</strong></font></legend>
                                                        ...
                                                        <%
                                                            ...
                                                            try {
                                                                ...
                                                                while (rs2.next()) {
                                                                    ...
                                                                    {
                                                                        Class.forName("com.mysql.jdbc.Driver");
                                                                        con3 = DriverManager.getConnection("jdbc:mysql://localhost:3306/e_commerce", "root", "root");;
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p><%=fname%></p>
                                                        <p><img src="view2.jsp?id=<%=fid%>" alt="" width="120" height="99" />
                                                            <font color="#0101DF" size="3"><strong><br><%=rs3.getString("status")%></strong></font></p>

                                                        <%} else {%>
                                                        <p><%=fname%></p>

                                                        <p><img src="view2.jsp?id=<%=fid%>" alt="" width="120" height="99" /><br> 
                                                            <a href="request.jsp?id=<%=rid%>"><font color="#0101DF" size="3"><strong>Send Request</strong><br></font></a></p>
