<%-- 
    ...
    Created on : Dec 13, 2016, 12:05:30 PM
    Author     : java4
--%>
...
%>
        ...
        <div id="content">
           ...
           <center><div class="col_w300">
                     <!---@1 part Start--->
                     <h3 class="service2" style="color: orange">Profile</h3>
                           <img src="view.jsp?id=<%=id%>" width="240" height="180"/><br><br>
                           <input type="text" value="<%=fname%>" readonly="" class="inputs" name="name" /><br>
                           <input type="text" value="<%=smail%>" readonly="" class="inputs" name="pass"/><br>
                           <input type="text" value="<%=age%>" readonly="" class="inputs" name="email"/><br>
                           <input type="text" value="<%=marital%>" readonly="" class="inputs" name="dob"/><br>
                           <input type="text" value="<%=edu%>" readonly="" class="inputs" name="email"/><br>
                           <input type="text" value="<%=interest%>" readonly="" class="inputs" name="dob"/><br>
