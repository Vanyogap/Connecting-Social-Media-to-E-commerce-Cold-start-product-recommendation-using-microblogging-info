    ...
    <div id="wrap" >
        ...
        <div id="left" >
            ...
            <ul id="menu" class="collapse">
                ...
                <li><a href="recommend1.jsp" >Recommendation</a></li>
                <li><a href="recom_de1.jsp">Recommended Details</a></li>
        ...
        ResultSet rs=st.executeQuery("select * from recomend1 where cat='"+cat+"'");
        while(rs.next())
        {
            int id=rs.getInt("id");
            String content=rs.getString("content");
            String cat1=rs.getString("cat");
            ...
            System.out.println("pname====="+pname);
                %>
                                                                ...
                                                                %>
                                                                        ...
                                                                        <img src="view6.jsp?id=<%=rs.getInt("id")%>" alt="" width="180" height="130" />
                                                                   
                                                                     <%=content%>   <a href="cart.jsp?cat=<%=cat%>&pname=<%=pname%>&id=<%=id%>&rate=<%=rate%>">Add To cart</a><br/>
